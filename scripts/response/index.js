export const response = (msg, color) => {
  ...
  container.classList.add('fixed', 'w-auto', 'px-4', 'p-2', 'font-semibold', `text-${color}-600`, 'text-center', 'top-20', '-right-full', 'z-50', 'rounded-full', 'border-2', `border-${color}-600`, 'transition-all', 'duration-700');
